...
internal sealed partial class IncludeDirectoryPicker : Window
{
	...
	public IncludeDirectoryPicker(string sourceDirectory, string existingIncludePaths = "", string disabledIncludePaths = "")
	{
		InitializeComponent();
	...
	public IncludeDirectoryPicker(string sourceDirectory, string existingIncludePaths, List<string> scopePaths, string disabledIncludePaths = "")
	{
		InitializeComponent();
		_sourceDirectory = sourceDirectory;
