...
public sealed class UnitMaterialLayoutReaderTests
{
    ...
    public void TryReadUnitMaterialSections_BindsEachMeshSectionToItsOwnMaterialTextures()
    {
        ...
        var layouts = UnitMaterialLayoutReader.TryReadUnitMaterialSections(
            unit,
    ...
    public void TryReadUnitMaterialSections_MarksDefaultMaterialMeshAsCullingBody()
    {
        ...
        Assert.AreEqual((uint)2280, section.IndexCount);
    }
    ...
    public void CreateSectionMesh_UsesMeshLocalIndicesAndAppliesUnitTransform()
    {
        ...
        var section = new ModelPreviewMaterialSection(
            ...
            ColorTextureId: 42,
            IsCullingBody: false,
            Transform: new ModelPreviewTransform(1, 0, 0, 10, 0, 1, 0, 20, 0, 0, 1, 30),
            MaterialId: 777);

        var mesh = UnitMaterialLayoutReader.CreateSectionMesh(source, section);
        ...
        CollectionAssert.AreEqual(new float[] { 10, 20, 30, 11, 20, 30, 10, 21, 30 }, mesh.Positions);
