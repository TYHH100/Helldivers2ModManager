...
## [1.6.0](https://github.com/TYHH100/Helldivers2ModManager/compare/v1.5.0...v1.6.0) (2026-09-12)
...
* **deployment:** add hard link deployment option ([e028e3a](https://github.com/TYHH100/Helldivers2ModManager/commit/e028e3a787713d8ed4ac827ea2a0675584f651f9))
...
* **model-preview:** 护甲下拉框按套装合并并默认选中第一个套装 ([7c1fd1e](https://github.com/TYHH100/Helldivers2ModManager/commit/7c1fd1ec9cc604c4e6977c599de9a1a5bc8700ba))
* **model-preview:** 接入头盔名称表并在复用检测中兜底 ([7e31fd9](https://github.com/TYHH100/Helldivers2ModManager/commit/7e31fd9696353d80b73c36feb0c638214d0c4d6d))
* **model-preview:** 新增代码驱动的虚拟化文本下拉控件 ([6f8e088](https://github.com/TYHH100/Helldivers2ModManager/commit/6f8e088d05ab8471cf10783ad8df4f8f0554bc69))
...
* **preview:** statically restore Lua scripts in model preview and extract them ([2d6be9a](https://github.com/TYHH100/Helldivers2ModManager/commit/2d6be9ad1a0004dca80d75dcc4782c042e6769b6))
...
* **preview:** 恢复流光/发光材质显示，撤销原版贴图解析、零面积过滤与强制不透明渲染 ([b1b9fe3](https://github.com/TYHH100/Helldivers2ModManager/commit/b1b9fe3e5e9f9c742699daf4111f63e9d07a64d7))
* **preview:** 武器模组自带动作预览支持与 60fps 动画播放 ([efa674a](https://github.com/TYHH100/Helldivers2ModManager/commit/efa674af4cbfc90ab21492bd002da3386fe1282a))
...
* separate mod library and configurations ([dd0e4e7](https://github.com/TYHH100/Helldivers2ModManager/commit/dd0e4e76a1cb4402d9873efb98b4e113142ede3a))
* **settings:** 导入模组时自动加入当前配置文件 ([b7e1969](https://github.com/TYHH100/Helldivers2ModManager/commit/b7e1969208da8b9d95b1570884c6cbf4d934f991))
* support encrypted archive import and export ([f0c8797](https://github.com/TYHH100/Helldivers2ModManager/commit/f0c8797dd8323d9ed018d7a118e889210bc8d0af))
...
* **import:** 嵌套压缩包共享冲突重试并恢复密码流程兜底 ([d382913](https://github.com/TYHH100/Helldivers2ModManager/commit/d3829134ba6a6b72a3f55cb9e25812e7f1650c55))
...
* **mod-group:** 非默认配置文件按成员顺序显示 ([4352b03](https://github.com/TYHH100/Helldivers2ModManager/commit/4352b03c9d3b3de3edd0e20e5e50f3c2b1f5f52c))
* **model-preview:** 修复动画绑定绕错轴并接入动画中英文名称表 ([68db876](https://github.com/TYHH100/Helldivers2ModManager/commit/68db8763ae8f62d5fb6d9287818f1bcbbd4f666f))
* **model-preview:** 刚性挂接件蒙皮与兼容性规则重写，护甲部件全面跟随动画 ([88d0548](https://github.com/TYHH100/Helldivers2ModManager/commit/88d0548be983c56815289a38c668173b2859a929))
* **model-preview:** 动画列表去掉 256 上限，下拉改用代码驱动控件 ([d21e6ba](https://github.com/TYHH100/Helldivers2ModManager/commit/d21e6ba81b1b9dc8c31148ee4e423208054f991c))
* **model-preview:** 默认站立姿势与朝向判定重构，消除预览平躺/倒立/横放 ([4fd2051](https://github.com/TYHH100/Helldivers2ModManager/commit/4fd2051dec15b2f4e3d563d4ea620694909aab12))
* **preview:** 贴图恢复一律不透明 Bgr32 渲染，撤销 IsOpacityMask 透明遮罩判定 ([22b22a5](https://github.com/TYHH100/Helldivers2ModManager/commit/22b22a588c718b776cf3264af00008e63843214a))
* **profile:** 持久化当前配置文件选择 ([54d7d5e](https://github.com/TYHH100/Helldivers2ModManager/commit/54d7d5e9c2c3ec9c09b04e0e1c338d56393411f1))
...
* reduce profile and mod library switch latency ([9f3c9a2](https://github.com/TYHH100/Helldivers2ModManager/commit/9f3c9a2b2c4b2958b4f12971ed6ca3fac2264c2b))
