...
internal enum ModelPreviewAnimationChannel
{
    Position,
    Rotation,
    Scale
...
internal readonly record struct ModelPreviewBonePose(
    Vector3 Position,
    Quaternion Rotation,
    Vector3 Scale)
{
...
internal readonly record struct ModelPreviewAnimationKeyframe(
    int BoneIndex,
    float TimeSeconds,
...
internal readonly record struct ModelPreviewAnimationEvent(
    uint EventId,
    float TimeSeconds);

internal sealed class ModelPreviewAnimationClip
{
...
/// </summary>
internal static class ModelPreviewAnimationParser
{
