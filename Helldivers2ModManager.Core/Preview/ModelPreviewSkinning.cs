...
public sealed class ModelPreviewSkeleton
{
...
public readonly record struct ModelPreviewSkeletonBone(
    int ParentIndex,
    uint NameHash,
    Matrix4x4 BindTransform);

public sealed class ModelPreviewBonePalette
{
...
public sealed class ModelPreviewUnitRig
{
...
public sealed class ModelPreviewSkinningData
{
...
public readonly record struct ModelPreviewAnimationResourceReference(
    ulong BonesId,
