...
/// </summary>
public sealed class PatchResourceInspectionResult
{
...
public sealed class ModelPreviewResult
{
    ...
    public int PreviewVertexCount { get; private set; }
    public int PreviewIndexCount { get; private set; }
    public bool IsAtCapacity => Meshes.Count >= 512 || PreviewVertexCount >= 1_000_000 || PreviewIndexCount >= 3_000_000;

    public bool TryAddMesh(ModelPreviewMesh mesh)
    {
...
/// </summary>
public sealed class ModelPreviewMesh : System.ComponentModel.INotifyPropertyChanged
{
    ...
    /// </summary>
    public IReadOnlyList<string> ArmorIds { get; private set; } = [];
    public void SetArmorIds(IReadOnlyList<string> armorIds) => ArmorIds = armorIds;
...
public sealed class ModelPreviewArmorOption : System.ComponentModel.INotifyPropertyChanged
{
...
public enum ModelPreviewMeshRenderStatus
{
    Visible,
    HiddenCullingBody,
    HiddenLargeOutlier,
...
/// </summary>
public static class ModelPreviewMeshSelector
{
...
public sealed record ModelPreviewSelection(IReadOnlyList<ModelPreviewMesh> VisibleMeshes, int HiddenMeshCount);

public sealed class TextureInspectionItem : System.ComponentModel.INotifyPropertyChanged
{
    public required string PatchFile { get; init; }
...
public enum TexturePreviewRole
{
    Unknown,
    ColorCandidate,
    LikelyNormalMap
...
public sealed class TexturePreviewData
{
    public required int Width { get; init; }
    public required int Height { get; init; }
...
public sealed class PatchTocInspectionItem
{
    public required string PatchFile { get; init; }
    public required string PatchPath { get; init; }
    public required int PatchOrder { get; init; }
...
public sealed class GpuStreamInspectionItem
{
    public required string PatchFile { get; init; }
    public required int TocEntryIndex { get; init; }
    public required ulong UnitId { get; init; }
