...
/// </summary>
public static class ModelPreviewMaterialVariantSelector
{
    ...
    public static bool IsBc7PureBlackPlaceholder(ReadOnlySpan<byte> data)
    {
    ...
    public static bool IsOpaqueBgraPureBlack(ReadOnlySpan<byte> pixels)
    {
